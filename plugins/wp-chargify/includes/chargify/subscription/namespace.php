...
use Chargify\Model\ChargifyUserFactory;
...
function create_wordpress_subscription( $chargify_subscription, $wordpress_data ) {
	...
	update_post_meta( $subscription_id, 'chargify_subscription_id', absint( $chargify_subscription['subscription']['id'] ) );
	...
	// TODO.
//	$chargify_user_factory = new ChargifyUserFactory();
//	$chargify_user         = $chargify_user_factory->get_by_id( $user_id );
//
//	if ( $chargify_user->get_chargify_account_id() ) {
//		$chargify_user->set_meta( 'chargify_account_id', $subscription_id, $chargify_user->get_chargify_account_id())
//	}
//	add_user_meta( $user_id, 'chargify_account_id', $subscription_id, true );
